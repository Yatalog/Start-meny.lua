...
local Window = Fluent:CreateWindow({
	Title = "BEST CHANNEL PTOFIC",
	SubTitle = "https://t.me/ptofic",
	TabWidth = 160,
...
local Tap = {
	General = Window:AddTab({Title = "Главное", Icon = "box"}),
	Event = Window:AddTab({Title = "Эвент", Icon = "star"}),
	Player = Window:AddTab({ Title = "Игроки", Icon = "user"}),
	Shop = Window:AddTab({ Title = "Магазин", Icon = "shopping-bag"}),
	Configs = Window:AddTab({Title = "Конфиг", Icon = "diamond"}),
	Teleport = Window:AddTab({Title = "Телепорт", Icon = "asterisk"}),
...
Event = Tap.Event:AddSection('Event') do
	...
	Event:AddButton({
		Title = "Телепортироваться к ингредиенту",
		Callback = function()
...
InfoFish = Tap.General:AddSection('Info Fish') do
	...
	InfoFish:AddButton({
		Title = "Получить информацию о рыбе",
		Callback = function()
...
MiscPlayer = Tap.Player:AddSection('Misc Player') do
	...
	MiscPlayer:AddButton({
		Title = "Воссоединиться с сервером",
		Description = "",
		Callback = function()
	...
	MiscPlayer:AddButton({
		Title = "Низкий уровень сервера перехода",
		Description = "",
		Callback = function()
...
WebHookConfigs = Tap.Configs:AddSection('WebHook') do
	...
	WebHookConfigs:AddButton({
		Title = "Тестирование веб-перехватчика",
		Description = "",
		Callback = function()
			local SendingSuccess = sendwebhook(Config['WebHook Configs'], {
